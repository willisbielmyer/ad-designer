...
import type { GoogleAd, GoogleDisplayAd, MetaAd, LSAAd } from '../types/ads';
...
type RightTab = 'preview' | 'instructions';
    ...
    <div className="builder-layout">
      ...
      <div className="builder-left">
        ...
        <p className="subtitle">
          Fill in your ad details — the preview updates live as you type.
        </p>
          ...
          {PLATFORMS.map((p) => (
            ...
            >
              <span
                ...
                style={platform === p.value ? { background: p.color } : {}}
              >
                {p.icon}
              </span>
              {p.label}
        ...
        {platform === 'google' && googleFormat === 'display' && (
          <GoogleDisplayForm
            ...
            initialValues={loadedValues?.platform === 'google' && (loadedValues as GoogleDisplayAd).format === 'display'
              ? (loadedValues as GoogleDisplayAd)
              : undefined}
          />
        )}
        {platform === 'meta' && (
        ...
        {activeTab === 'instructions' && submitted && (
          <div className="right-panel-content">
            <div className="instructions-header">
              <div className="platform-badge" style={{ background: activePlatform.color }}>
                {activePlatform.icon}
              </div>
              <div>
                ...
                <p className="subtitle">
                  ...
                  {submitted.platform === 'google' && (submitted as GoogleAd | GoogleDisplayAd).format === 'display'
                    ? ' Display'
                    : submitted.platform === 'google'
                    ? ' Search'
                    : ''}
